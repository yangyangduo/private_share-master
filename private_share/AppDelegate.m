...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [DrawerViewController defaultConfig].leftDrawerViewVisibleWidth = 250;
    [DrawerViewController defaultConfig].triggerHideLeftDrawerViewX = 190;
    
    // Center view controller
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:[[PortalViewController alloc] init]];
    ...
    DrawerViewController *drawerViewController = [[DrawerViewController alloc] initWithLeftViewController:leftDrawerViewController rightViewController:nil centerViewController:navigationController];
