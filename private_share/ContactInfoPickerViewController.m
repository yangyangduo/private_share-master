...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *remark = [ShoppingCart myShoppingCart].orderRemark;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(indexPath.row == 0) {
        ...
        textView.identifier = @"kRemark";
        textView.defaultValue = remark ? remark : @"";
        textView.descriptionText = [NSString stringWithFormat:@"%@%@:", NSLocalizedString(@"please_enter", @""), NSLocalizedString(@"remark_no_blank", @"")];
    }
...
- (void)textViewController:(TextViewController *)textViewController didConfirmNewText:(NSString *)newText {
    ...
    } else if([@"kRemark" isEqualToString:textViewController.identifier]) {
        [ShoppingCart myShoppingCart].orderRemark = newText;
    }
    [contactInfoTableView reloadData];
