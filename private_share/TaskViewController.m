...
- (void)setPoins:(NSInteger)points {
    totalPointsMessageLabel.text = [NSString stringWithFormat:@"%@: %d%@", NSLocalizedString(@"total_points", @""), points, NSLocalizedString(@"points_short", @"")];
}

- (void)setPointsToday:(NSInteger)points {
    todayPointsMessageLabel.text = [NSString stringWithFormat:@"%@: %d%@", NSLocalizedString(@"points_today", @""), points, NSLocalizedString(@"points_short", @"")];
}
